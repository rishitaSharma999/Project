    ...
    <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center">
      {loading ? (
        ...
        <div className="max-w-[500px] p-8">
          <h1 className="text-4xl font-semibold leading-[2.375rem] text-emerald-300 text-center">
          ...
          <form onSubmit={handleOnSubmit}>
            {!emailSent && (
              <label className="w-full">
                <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-emerald-200 mt-7">
